...
<head>
<title>Mapa Sitio | SpookTech</title>
	...
	<div class="tail-bottom">
		<div class="body-bg">
			...
			<div id="header">
				...
				<div class="row-2">
					<ul>
						<li class="m1"><a href="index.jsp">Home</a></li>
						...
						<li class="m6"><a href="sitemap.jsp" class="active">Mapa Sitio</a></li>
					</ul>
				</div>
						...
						<div class="col-1">
							<div class="indent">
								...
								<ul class="list2">
									...
									<li><a href="support.jsp">Soporte</a></li>
									<li><a href="contact-us.jsp">Contacto</a></li>
									<li><a href="sitemap.jsp">Mapa Sitio</a></li>
								</ul>
